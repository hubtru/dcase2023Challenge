...
def main():
    ...
    data_train, data_test, data_test_classification = compute_all_features(audio_all, datasets=datasets,
    ...
    print(data_test_classification.dtype)
    print(np.shape(data_test_classification))
    print(data_test_classification[0])
    ...
    encoding_dim = 128
    autoencoder = train_autoencoder(normalized_train_data, encoding_dim, epochs=10,
